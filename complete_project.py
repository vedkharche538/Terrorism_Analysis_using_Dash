...
def load_data():
  dataset_name = "D:\AI,ML Session\Project3\global_terror.csv"
      ...
      dcc.Tab(label = "Chart Tool", id="chart tool", value="Chart", children=[
          dcc.Tabs(id = "subtabs2", value = "WorldChart",children = [
              ...
              dcc.Tab(label="India Chart tool", id="IndiaC", value="IndiaChart", children = [
                  html.Br(),
                  dcc.Dropdown(id="Chart_Dropdown_india", options = chart_dropdown_values, placeholder="Select option", value = "region_txt",disabled=True), 
                  html.Br(),
                  html.Hr(),
                  dcc.Input(id="search", placeholder="Search Filter"),
                  html.Hr(),
